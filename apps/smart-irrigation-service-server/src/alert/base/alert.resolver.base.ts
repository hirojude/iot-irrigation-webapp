...
export class AlertResolverBase {
  ...
  async createAlert(@graphql.Args() args: CreateAlertArgs): Promise<Alert> {
    return await this.service.createAlert({
      ...
      data: {
        ...
        weatherstation: args.data.weatherstation
          ? {
              connect: args.data.weatherstation,
            }
          : undefined,
      },
    });
  ...
  async getUser(@graphql.Parent() parent: Alert): Promise<User | null> {
  ...
  @graphql.ResolveField(() => Weatherstation, {
    nullable: true,
    name: "weatherstation",
  })
  async getWeatherstation(
    ...
    const result = await this.service.getWeatherstation(parent.id);
